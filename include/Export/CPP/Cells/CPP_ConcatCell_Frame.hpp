...
#ifndef N2D2_CPP_CONCAT_CELL_FRAME_H
#define N2D2_CPP_CONCAT_CELL_FRAME_H
...
class CPP_ConcatCell_Frame final: public virtual CPP_ConcatCell, 
...
public:
    ...
    CPP_ConcatCell_Frame(const DeepNet& deepNet, const std::string& name,
