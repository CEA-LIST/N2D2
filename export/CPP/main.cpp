...
void readStimulus(const N2D2::NetworkQAT& network, const std::string& stimulusPath,
...
template<typename Input_T, typename Output_T>
double processInput(const N2D2::NetworkQAT& network, std::vector<Input_T>& inputBuffer,
                            std::vector<Output_T>& expectedOutputBuffer,
