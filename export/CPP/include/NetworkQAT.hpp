...
#ifndef N2D2_NetworkQAT_HPP
#define N2D2_NetworkQAT_HPP
...
private:
    ...
    template<// For all inputs
            ...
            int NB_OUTPUTS,
            int OUTPUTS_HEIGHT, int OUTPUTS_WIDTH,
            N2D2::NetworkQAT::ElemWiseOp ELEM_OP,
...
template<typename Output_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::concatenate(
    Output_T* __restrict /*outputs*/,
    int /*pos*/) const {}
...
template<// For all inputs
         ...
         // Types
         typename Input_T, typename Output_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::concatenatePropagate(
    Output_T* __restrict outputs,
    const Input_T* __restrict firstInputs,
    INPUTS... inputs) const
{
...
template<N2D2::NetworkQAT::ElemWiseOp ELEM_OP>
N2D2_ALWAYS_INLINE inline SUM_T N2D2::NetworkQAT::elemWise(
    int /*pos*/,
    int /*ch*/) const
{
    return 0;
...
template<// For all inputs
         ...
         typename Input_T, typename Output_T,
         typename Rescaling_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::elemWisePropagate(
    Output_T* __restrict outputs,
    const Rescaling_T& __restrict rescaling,
    const Input_T* __restrict firstInputs,
    INPUTS... inputs) const
...
template<int NB_CHANNELS, 
         ...
         typename Weight_T, typename Bias_T,
         typename Rescaling_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::convcellPropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs,
    const Bias_T* __restrict biasses,
    const Weight_T* __restrict weights,
...
template<int NB_CHANNELS, 
         ...
         typename Weight_T, typename Bias_T,
         typename Rescaling_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::convcellDWPropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs,
    const Bias_T* __restrict biasses,
    const Weight_T* __restrict weights,
...
template<int NB_CHANNELS, 
         ...
         int OUTPUT_MEM_STRIDE,
         typename Input_T, typename Output_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::poolcellPropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs) const
{
...
template<int NB_CHANNELS, 
         ...
         typename Weight_T, typename Bias_T,
         typename Rescaling_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::fccellPropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs,
    const Bias_T* __restrict biasses,
    const Weight_T* __restrict weights,
...
template<typename Output_T>
inline void N2D2::NetworkQAT::saveOutputs(
    int NB_OUTPUTS,
    int OUTPUTS_HEIGHT, int OUTPUTS_WIDTH,
    int OUTPUT_MEM_CONT_OFFSET,
    int OUTPUT_MEM_CONT_SIZE,
...
template<int NB_CHANNELS,
         ...
         int INPUT_MEM_STRIDE,
         typename Input_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::maxPropagate(
    const Input_T* __restrict inputs,
    int32_t* __restrict outputs) const
{
    int iMaxInput = 0;
...
template<int NB_CHANNELS, 
         ...
         int OUTPUT_MEM_STRIDE,
         typename Input_T, typename Output_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::resizeNearestNeighborPropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs) const
{
    static_assert(NB_CHANNELS == NB_OUTPUTS,
...
template<int NB_CHANNELS, 
         ...
         typename Input_T, typename Output_T,
         typename Rescaling_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::scalingPropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs,
    const Rescaling_T& __restrict rescaling) const
{
...
template<int NB_CHANNELS, 
         ...
         int OUTPUT_MEM_STRIDE,
         typename Input_T, typename Output_T>
N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::transposePropagate(
    const Input_T* __restrict inputs,
    Output_T* __restrict outputs,
    const int perm[4]) const
{
...
N2D2_ALWAYS_INLINE inline N2D2::NetworkQAT::Tick_T N2D2::NetworkQAT::tick() const {
    return std::chrono::high_resolution_clock::now();
}

N2D2_ALWAYS_INLINE inline void N2D2::NetworkQAT::benchmark(const char* name,
                                                        const Tick_T& start,
                                                        const Tick_T& end,
                                                        RunningMean_T& timing) const
{
