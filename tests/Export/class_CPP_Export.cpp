...
TEST_DATASET(CPP_Export_QAT_4b, generate,
    ...
    std::make_tuple("tests_data/mnist_model/LeNet_4b.ini", "tests_data/mnist_model/weights_LeNet_4b",
                    "export_CPP_QAT_LeNet4b_FloatPoint/", true, 10000, "CPP",
                    ClippingMode::NONE, ScalingMode::FLOAT_MULT, WeightsApprox::RINTF, 99.23),
    std::make_tuple("tests_data/mnist_model/LeNet_4b.ini", "tests_data/mnist_model/weights_LeNet_4b",
                    "export_CPP_QAT_LeNet_4b_FixedPoint/", true, 10000, "CPP",
                    ClippingMode::NONE, ScalingMode::FIXED_MULT32, WeightsApprox::RINTF, 99.20))
{
    REQUIRED(UnitTest::DirExists(N2D2_DATA("mnist")));
