...
N2D2 design and development issues, bugs and feature requests are maintained by [GitHub Issues](https://github.com/CEA-LIST/N2D2/issues).

N2D2 also welcomes all code contributions, through [Pull requests](https://github.com/CEA-LIST/N2D2/pulls). Before we can take them, please make sure to first read and understand the following Contributor Agreement.


## Contributor Agreement

Thank you for your interest in contributing to N2D2 ("We" or "Us").

The purpose of this contributor agreement ("Agreement") is to clarify and document the rights granted by contributors to Us. To make this document effective and get started, please sign the Contributor License Agreement at [https://www.clahub.com/agreements/CEA-LIST/N2D2](https://www.clahub.com/agreements/CEA-LIST/N2D2).
...
**"Contribution"** means any original work of authorship (software and/or documentation) including any modifications or additions to an existing work, Submitted by You to Us, in which You own the Copyright. If You do not own the Copyright in the entire work of authorship, please contact Us.
