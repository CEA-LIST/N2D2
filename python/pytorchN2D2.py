...
parser.add_argument('--precision', '-p', type=float, default=0.0001, help='Difference threshold between Torch and N2D2 values allowed before raising an error (default=0.001)')
